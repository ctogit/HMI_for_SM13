...
def dk_SM13(f_pole_ang, f_arm_ang, f_l1, f_l2, f_l3, f_l4):
    ...
    depurador(4, "dk_SM13", "****************************************")
    depurador(4, "dk_SM13", "- Cinemática Directa SM-13")
    depurador(4, "dk_SM13", " ")
    depurador(4, "dk_SM13", "- Lx = " + str(f_l1))
    depurador(4, "dk_SM13", "- Ly = " + str(f_l2))
    depurador(4, "dk_SM13", "- Longitud_POLE = " + str(f_l3))
    depurador(4, "dk_SM13", "- Longitud_ARM  = " + str(f_l4))
    depurador(4, "dk_SM13", " ")
    depurador(4, "dk_SM13", "- Ángulo POLE = "+str(f_qp))
    depurador(4, "dk_SM13", "- Ángulo ARM  = "+str(f_qa))
    depurador(4, "dk_SM13", " ")
    depurador(4, "dk_SM13", "- Sonda en x = "+str(f_px_sonda)+", y = "+str(f_py_sonda))
    depurador(4, "dk_SM13", " ")
